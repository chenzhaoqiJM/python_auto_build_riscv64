...
# 可配置字段
export PIP_CACHE_DIR="$HOME/.cache/pip/wheels_test_uv_$BUILD_FOR_VERSION"
BUILD_TMPDIR="$HOME/.mytmp/mytmphp_init_uv_$BUILD_FOR_VERSION"
VENV_NAME="tmpbuild_init_uv_$BUILD_FOR_VERSION"
