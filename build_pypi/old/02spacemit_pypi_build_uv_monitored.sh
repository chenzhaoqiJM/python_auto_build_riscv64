#!/bin/bash
# 02spacemit_pypi_build_uv_monitored.sh - 带监控上报的 Spacemit PyPI 源构建脚本
# 这是 02spacemit_pypi_build_uv.sh 的复制版本，集成了构建状态监控上报功能
set -e
...
SCRIPT_NAME="02spacemit_pypi_build"
...
# ========== 监控日志目录 ==========
BUILD_LOG_DIR="$HOME/.build_logs/spacemit_uv_$BUILD_FOR_VERSION"
